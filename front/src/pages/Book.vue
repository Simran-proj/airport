      ...
      <div class="container mx-auto px-4 py-4">
        <div class="flex items-center justify-between">
          <div class="flex items-center">
            <div class="bg-gradient-to-r from-[#4E56C0] to-[#9B5DE0] text-white rounded-full w-8 h-8 flex items-center justify-center mr-2">
              1
            </div>
      ...
      <div class="max-w-4xl mx-auto">
              ...
              <div class="space-y-4">
                <div class="flex items-start">
                  ...
                  <label for="eco-friendly" class="text-gray-700">
                    ...
                    <p class="text-sm text-gray-600 mt-1">Your car will be parked in our eco-zone with solar charging available.</p>
                  </label>
                </div>
              </div>
            </div>
              ...
              <div class="flex items-start">
                ...
                <label for="terms" class="text-gray-700">
                  ...
                  <p class="text-sm text-gray-600 mt-2">
                    By proceeding, you confirm that all information provided is accurate and authorize Heathrow Air Park to process your booking. You agree to our 
            ...
            <div class="space-y-4">
              ...
              <div class="flex justify-center gap-6 pt-4">
                <div class="flex items-center text-gray-600">
                  <svg class="w-4 h-4 text-[#4E56C0] mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd" />
                  </svg>
                  <span class="text-sm">SSL Secured</span>
                </div>
                <div class="flex items-center text-gray-600">
                  <svg class="w-4 h-4 text-[#9B5DE0] mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                  </svg>
                  <span class="text-sm">Fully Insured</span>
                </div>
                <div class="flex items-center text-gray-600">
                  <svg class="w-4 h-4 text-[#D78FEE] mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                  </svg>
        ...
        <div v-if="!bookingError && !timeSlotTaken" class="bg-white rounded-xl shadow-lg p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="text-center p-4 border border-[#FDCFFA] rounded-lg">
              <div class="flex justify-center mb-3">
                <svg class="w-8 h-8 text-[#9B5DE0]" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="text-center p-4 border border-[#FDCFFA] rounded-lg">
              <div class="flex justify-center mb-3">
                <svg class="w-8 h-8 text-[#D78FEE]" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
...
const checkTimeSlotAvailability = async () => {
  ...
  try {
    // Aquí deberías tener un endpoint en tu backend para verificar disponibilidad
    // Por ahora, usaremos un fetch simple
...
const submitBooking = async () => {
  ...
  try {
    ...
    if (response.ok && result.success) {
      // Si hay error de horario ocupado
