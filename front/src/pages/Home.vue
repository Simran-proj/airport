      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            ...
            <form @submit.prevent="calculatePrice" class="space-y-6">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select 
                    ...
                    required
                    :disabled="!searchData.dropOffDate || loadingAvailability"
                    @change="checkPickupAvailability"
                    class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#4E56C0] focus:border-transparent"
                  >
                    <option value="">Select Time</option>
                    <option 
                      v-for="time in availableDropOffTimes" 
                      :key="time"
                      :value="time"
                    >
                ...
                <div>
                  ...
                  <input 
                    ...
                    type="date"
                    :min="searchData.dropOffDate || minDate"
                    required
                    @change="checkPickupAvailability"
                    class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#4E56C0] focus:border-transparent"
                  />
                ...
                <div>
                  ...
                  <div v-if="searchData.pickUpDate && searchData.dropOffTime && !loadingPickupAvailability" class="mt-2">
              ...
              <div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                  <label class="flex items-center p-3 border border-gray-300 rounded-lg cursor-pointer hover:bg-[#FDCFFA]/10 transition-colors">
                    <input 
              ...
              <!-- Price Display -->
              <div v-if="calculatedPrice > 0 && isDropOffTimeAvailable && isPickUpTimeAvailable" class="bg-gradient-to-r from-[#FDCFFA]/20 to-[#D78FEE]/20 p-6 rounded-lg border-2 border-[#D78FEE]">
              ...
              >
                ...
                <span v-else>
                  <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path fill-rule="evenodd" d="M11 6a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd"></path>
                  </svg>
          ...
          <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
            ...
            <div class="mt-6 p-4 bg-gradient-to-r from-[#FDCFFA]/30 to-[#D78FEE]/30 rounded-lg">
              <div class="flex items-center">
                <svg class="w-6 h-6 mr-3 text-[#4E56C0]" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" d="M4 4a2 2 0 00-2 2v4a1 1 0 001 1h1a1 1 0 100-2H4V6h3a1 1 0 100-2H4zm9 0a1 1 0 100 2h1a1 1 0 011 1v1a1 1 0 01-1 1h-1a1 1 0 100 2h1a1 1 0 011 1v1a1 1 0 01-1 1h-1a1 1 0 100 2h1a2 2 0 002-2v-1a2 2 0 00-.878-1.657l1.5-1.5A2 2 0 0016 8V7a2 2 0 00-2-2h-1zm-6 2a1 1 0 011-1h3a1 1 0 011 1v6a1 1 0 01-1 1H8a1 1 0 01-1-1V6z" clip-rule="evenodd"></path>
                </svg>
                <div>
          ...
          <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div class="text-center">
                <div class="bg-gradient-to-br from-[#FDCFFA] to-[#D78FEE] p-4 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                  <svg class="w-8 h-8 text-[#4E56C0]" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z"></path>
                  </svg>
                </div>
                <h4 class="font-bold text-lg mb-2">Direct Partnership</h4>
                <p class="text-gray-600">We work directly with Heathrow parking facilities, cutting out middlemen fees.</p>
              </div>
              <div class="text-center">
                <div class="bg-gradient-to-br from-[#FDCFFA] to-[#D78FEE] p-4 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                  <svg class="w-8 h-8 text-[#4E56C0]" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="space-y-8">
          ...
          <div class="bg-gradient-to-br from-[#FDCFFA] to-[#D78FEE] text-[#4E56C0] rounded-xl shadow-lg p-6">
            ...
            <div class="space-y-4">
              <div class="flex items-start">
                <svg class="w-5 h-5 mt-0.5 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <div class="space-y-3">
              <div class="flex justify-between items-center p-3 bg-gradient-to-r from-[#4E56C0]/5 to-[#9B5DE0]/5 rounded-lg">
                <div>
              ...
              <div class="flex justify-between items-center p-3 bg-gradient-to-r from-[#9B5DE0]/5 to-[#D78FEE]/5 rounded-lg">
                <div>
              ...
              <div class="flex justify-between items-center p-3 bg-gradient-to-r from-[#D78FEE]/5 to-[#FDCFFA]/5 rounded-lg">
                <div>
              ...
              <div class="flex justify-between items-center p-3 bg-gradient-to-r from-[#FDCFFA]/5 to-[#4E56C0]/5 rounded-lg">
                <div>
          ...
          <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <div class="space-y-4">
              <div class="border-l-4 border-[#4E56C0] pl-4">
                ...
                <p class="text-gray-600 italic">"Saved £56 compared to Heathrow official parking. Same service, half the price!"</p>
              ...
              <div class="border-l-4 border-[#4E56C0] pl-4">
                ...
                <p class="text-gray-600 italic">"£32 cheaper than APCOA for my 5-day trip. Will never use anyone else!"</p>
                <div class="flex justify-between items-center mt-2">
          ...
          <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <ul class="space-y-3">
              <li class="flex items-center">
                <svg class="w-5 h-5 text-[#4E56C0] mr-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                </svg>
            ...
            <div class="mt-6 p-3 bg-gradient-to-r from-[#FDCFFA]/20 to-[#D78FEE]/20 rounded-lg">
              <p class="text-sm text-gray-700">
                <span class="font-bold text-[#4E56C0]">Note:</span> We're cheaper because we're efficient, not because we cut corners on service.
              </p>
            </div>
          </div>
        </div>
